...
export const Conversation = IDL.Record({
  'participantAccountIds' : IDL.Vec(AccountId),
  'createdAt' : Timestamp,
  'updatedAt' : Timestamp,
...
export const StewardAuditKind = IDL.Variant({
  'ConflictResolution' : IDL.Null,
  'Governance' : IDL.Null,
});
export const StewardAuditEntry = IDL.Record({
  'id' : IDL.Nat,
  'field' : IDL.Opt(IDL.Text),
  'affectedPersonIds' : IDL.Vec(IDL.Text),
  'proposedValue' : IDL.Opt(IDL.Text),
  'stewardNotes' : IDL.Opt(IDL.Text),
  'kind' : StewardAuditKind,
  'proposedSourceId' : IDL.Opt(IDL.Nat),
  'actionType' : IDL.Text,
  'resolution' : IDL.Opt(IDL.Text),
  'existingValue' : IDL.Opt(IDL.Text),
  'summary' : IDL.Text,
  'personId' : IDL.Opt(IDL.Text),
  'timestamp' : IDL.Int,
...
export const DisputedFact = IDL.Record({
  'field' : IDL.Text,
  'status' : ReviewStatus,
  'proposedValue' : IDL.Text,
  'canonicalValue' : IDL.Text,
...
export const idlService = IDL.Service({
  ...
  'approveRecipeForFamily' : IDL.Func(
      [FamilyId, RecipeId],
      [IDL.Opt(Recipe)],
      [],
    ),
  ...
  'canMessagePersonForFamily' : IDL.Func(
      [FamilyId, IDL.Text],
      [IDL.Bool],
      ['query'],
    ),
  ...
  'getConversationForFamily' : IDL.Func(
  ...
  'getNotificationForFamily' : IDL.Func(
      [FamilyId, NotificationId],
  ...
  'getReportedMessageForFamily' : IDL.Func(
      [FamilyId, ReportId],
      [IDL.Opt(ReportedMessageView)],
      ['query'],
    ),
  ...
  'listApprovedRecipesForFamily' : IDL.Func(
      [FamilyId],
      [IDL.Vec(Recipe)],
      ['query'],
    ),
  ...
  'listConversationsForFamily' : IDL.Func(
      [FamilyId],
  ...
  'listNotificationsForFamily' : IDL.Func(
      [FamilyId],
  ...
  'listPendingRecipesForFamily' : IDL.Func(
      [FamilyId],
      [IDL.Vec(Recipe)],
      ['query'],
    ),
  ...
  'listRecipesForFamily' : IDL.Func([FamilyId], [IDL.Vec(Recipe)], ['query']),
  'listRecipesForPerson' : IDL.Func([IDL.Text], [IDL.Vec(Recipe)], ['query']),
  'listRecipesForPersonForFamily' : IDL.Func(
      [FamilyId, IDL.Text],
      [IDL.Vec(Recipe)],
      ['query'],
    ),
  ...
  'listReportsForFamily' : IDL.Func([FamilyId], [IDL.Vec(Report)], ['query']),
  ...
  'listUnreadNotificationsForFamily' : IDL.Func(
      [FamilyId],
      [IDL.Vec(Notification)],
      ['query'],
    ),
  'markAllNotificationsReadForFamily' : IDL.Func([FamilyId], [IDL.Nat], []),
  ...
  'markNotificationReadForFamily' : IDL.Func(
      [FamilyId, NotificationId],
      [IDL.Opt(Notification)],
      [],
    ),
  ...
  'publishRecipeForFamily' : IDL.Func(
      [
        FamilyId,
        IDL.Text,
        IDL.Text,
  ...
  'rejectRecipeForFamily' : IDL.Func(
      [FamilyId, RecipeId],
      [IDL.Opt(Recipe)],
      [],
    ),
  ...
  'submitRecipeForFamily' : IDL.Func(
      [
        FamilyId,
        IDL.Text,
        IDL.Text,
...
export const idlFactory = ({ IDL }) => {
  ...
  const StewardAuditKind = IDL.Variant({
    'ConflictResolution' : IDL.Null,
    'Governance' : IDL.Null,
  });
  const StewardAuditEntry = IDL.Record({
    'id' : IDL.Nat,
    'field' : IDL.Opt(IDL.Text),
    'affectedPersonIds' : IDL.Vec(IDL.Text),
    'proposedValue' : IDL.Opt(IDL.Text),
