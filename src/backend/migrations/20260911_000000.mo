...
module {
  ...
  // unchanged. `stewards` and `accessControlState` are added to the subset
  // because they are the surviving evidence the ownership recovery below reads
  // (the data-loss migration 20260905_000000.mo does NOT touch them).
  type OldActor = {
    accessControlState : {
