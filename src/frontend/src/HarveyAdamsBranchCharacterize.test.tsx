...
// minimal actor. Explore Family / Heritage Branch are gated behind approved
// family access, so the signed-in caller must hold an approved (CLAIMED)
// profile for the family graph to render; getMyProfile resolves that approved
// claim.
